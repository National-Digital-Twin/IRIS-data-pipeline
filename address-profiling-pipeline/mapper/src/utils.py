...
def add_ies_building_type_mappings(ies: IESTool, subject: str, types: list[str]) -> None:
    """
...
def add_attribute_of_state_mapping(ies: IESTool, record: dict, attribute_name: str, attribute_types: list[str], entity_uris: list[str], entity_state_uris: list[str]) -> str:
    """
...
def add_bnode_with_ies_type_and_value(ies: IESTool, type: str, literal_value: str) -> BNode:
    """
...
def add_bnode_with_ies_building_type_and_value(ies: IESTool, type: str, literal_value: str) -> BNode:
    """
